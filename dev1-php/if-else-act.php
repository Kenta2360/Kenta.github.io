...
<body>
  ...
  if (isset($_POST['diff'])){
    ...
    if($num1 > $num2){
      echo "<div class='w-25 mx-auto text-center bg-primary'>
    First Number: ".$num1."<br>Second Number ".$num2.
    "<br>The Difference is: ".compute($num1, $num2);
    }elseif($num1==$num2){
      echo "<div class='w-25 mx-auto text-center bg-warning'>
      First Number: ".$num1."<br>Second Number ".$num2.
      "<br>".compute($num1, $num2);
    }else{
      echo "<div class='w-25 mx-auto text-center bg-success'>
    First Number: ".$num1."<br>Second Number ".$num2.
    "<br>The Product is: ".compute($num1, $num2);
    }
  }
?>
