...
<body>
  <div class="container">
    <div class="card w-25 mx-auto my-4">
      <div class="card-header">
        <h1 class="text-center"> Withdrawal Slip</h1>
      </div>
      <div class="card-body">
        <form action="" method="post">
          ...
          <input type="number" name="amount" id="" placeholder="Withdraw amount..." class="form-control my-3" required>
          <input type="submit" name="withdraw" value="withdraw" class="btn btn-primary w-100">
        </form>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="border rounded w-25 mx-auto">
      <h1 class="text-center">Withdrawal Receipt</h1>
      <hr>
