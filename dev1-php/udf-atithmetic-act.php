...
<body>
  ...
  ?>
        <div class="container-fluid">
          <div class="border rounded px-3 pt-3 pb-2 bg-primary w-25 mx-auto">
            <table class="text-center fw-bold text-white mb-4 mx-auto w-100">
              <tr class="border-bottom border-secondary bg-dark">
                <td class="py-2">First Number</td>
                <td class="py-2">Second Number</td>
              <tr class="border-bottom bg-dark ">
                <td class="py-2"><?= $num_1 ?></td>
                <td class="py-2"><?= $num_2 ?></td>
              </tr>
              <tr class="border-bottom">
                <td class="py-2">The sum is</td>
                <td class="py-2"><?= sum($num_1, $num_2) ?></td>
              </tr>
              <tr class="border-bottom">
                <td class="py-2">The difference is</td>
                <td class="py-2"><?= diff($num_1, $num_2) ?></td>
              </tr>
              <tr class="border-bottom">
                <td class="py-2">The product is</td>
                <td class="py-2"><?= prod($num_1, $num_2) ?></td>
              </tr>
              <tr class="border-bottom">
                <td class="py-2">The quotient is</td>
                <td class="py-2"><?= quot($num_1, $num_2) ?></td>
              </tr>
            </table>
          </div>
        </div>
...
<?php
        ...
        function prod($num_1, $num_2){
          echo $num_1 * $num_2;
        }
        function quot($num_1, $num_2){
          echo $num_1 / $num_2;
        }
?>